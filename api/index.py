...
async def get_dashboard():
    ...
    <head>
        ...
        <script>
            ...
            // ==========================================
            // SARVAM AI HYPER-REALISTIC VOICE ASSISTANT
            // ==========================================
            async function activateVoiceAssistant() {{
                ...
                // Show loading animation while fetching from Sarvam
                voiceBtn.innerHTML = "⏳";
                ...
                try {{
                    ...
                    if (data.status === "success" && data.audio_base64) {{
                        voiceBtn.innerHTML = "🔊";
                        // Play the ultra-realistic base64 WAV audio generated by Sarvam
                        ...
                        // Fallback to robotic browser voice ONLY if Sarvam API fails
                        console.error("Sarvam API failed, using fallback.");
                        voiceBtn.innerHTML = "🔊";
